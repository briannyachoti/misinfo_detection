...
embedding_path = os.path.join(DATA_DIR, "embeddings", "test_roberta_embeddings.csv")

# === Load Data ===
comparison_df = pd.read_csv(comparison_path)
text_df = pd.read_csv(test_cleaned_path)
embeddings_df = pd.read_csv(embedding_path)
merged = pd.concat([text_df.reset_index(drop=True), comparison_df], axis=1)
